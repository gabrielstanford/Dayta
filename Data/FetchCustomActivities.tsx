...
export const ActivityButtons: ButtonState[] = [
  ...
  { text: 'Jogging', iconLibrary: "materialCommunityIcons", icon: "run", keywords: ['Jogging'], pressed: false, tags: ['Physical'], category: ["Intense Activity", "Sunlight"], movementIntensity: 8 },
  { text: 'Cycling', iconLibrary: "fontAwesome5", icon: "bicycle", keywords: ['Biking'], pressed: false, tags: ['Physical'], category: ["Intense Activity", "Sunlight"], movementIntensity: 8 },
  { text: 'Swimming', iconLibrary: "materialCommunityIcons", icon: "swim", keywords: ['Pool', 'Laps'], pressed: false, tags: ['Physical'], category: ["Intense Activity"], movementIntensity: 10 },
  { text: 'Gym', iconLibrary: "materialCommunityIcons", icon: "weight-lifter", keywords: ['Exercise', 'Workout'], pressed: false, tags: ['Physical'], category: ["Workout", "Sunlight"], movementIntensity: 8 },
  { text: 'Home Workout', iconLibrary: "materialCommunityIcons", icon: "jump-rope", keywords: ['Working Out', 'Exercise', 'Gym'], pressed: false, tags: ['Physical'], category: ["Workout"], movementIntensity: 7 },
  { text: 'Home Physical Therapy', iconLibrary: "ionicons", icon: "medkit", keywords: ['Working Out', 'Exercise', 'Gym', 'Physical Therapy', 'PT', 'Rehab'], pressed: false, tags: ['Physical'], category: ["Workout"], movementIntensity: 6 },
  { text: 'Yoga', iconLibrary: "materialCommunityIcons", icon: "yoga", keywords: ['Stretching', 'Meditation'], pressed: false, tags: ['Physical'], category: ["Light Activity", "Meditation"], movementIntensity: 8 },
  ...
  { text: 'Hiking', iconLibrary: "fontAwesome5", icon: "hiking", keywords: ['Going For A Hike', 'Taking A Hike', 'Hike'], pressed: false, tags: ['Physical', 'Outdoor'], category: ['Sunlight'], movementIntensity: 6 },
  { text: 'Maximum Tabata', iconLibrary: "materialCommunityIcons", icon: "run", keywords: ['20 Minute', 'The Maximum'], pressed: false, tags: ['Physical'], movementIntensity: 8 },
  ...
  // Entertainment
  { text: 'TV Watching', iconLibrary: "materialIcons", icon: "tv", keywords: ['Television', 'Netflix', 'Hulu', 'TV Shows', 'Movies'], pressed: false, tags: ['Entertainment'], category: ["Electronics", "Dopamine Rush"], movementIntensity: 0 },
  { text: 'Movie Watching', iconLibrary: "fontAwesome5", icon: "film", keywords: ['Cinema', 'Film', 'Theater', 'Theatre'], pressed: false, tags: ['Entertainment'], category: ["Electronics", "Dopamine Rush"], movementIntensity: 0 },
  { text: 'Social Media', iconLibrary: "materialCommunityIcons", icon: "twitter", keywords: ['Instagram', 'Facebook', 'Twitter', 'Snapchat', 'Socializing', 'Online', 'Scrolling'], pressed: false, tags: ['Entertainment'], category: ["Electronics", "Dopamine Rush"], movementIntensity: 0 },
  { text: 'Gaming', iconLibrary: "materialCommunityIcons", icon: "gamepad-variant-outline", keywords: ['Video Games', 'Computer Games', 'PlayStation', 'Xbox', 'Nintendo'], pressed: false, tags: ['Entertainment', 'Dopamine Rush'], category: ["Electronics"], movementIntensity: 0 },
  { text: 'Reading', iconLibrary: "materialIcons", icon: "menu-book", keywords: ['Books', 'Novels', 'Comics'], pressed: false, tags: ['Relax'], category: ["Mental Stimulation"], movementIntensity: 0},
  { text: 'Going to a Museum', iconLibrary: "fontAwesome5", icon: "university", keywords: ['Art', 'History', 'Exhibits'], pressed: false, tags: ['Entertainment'], movementIntensity: 3},
  { text: 'Other Entertainment Activity', iconLibrary: "materialIcons", icon: "more-horiz", keywords: ['Miscellaneous'], pressed: false, tags: ['Entertainment'], movementIntensity: 0},
  // Social
  { text: 'Going to a Party', iconLibrary: "materialCommunityIcons", icon: "party-popper", keywords: ['Celebration', 'Friends', 'Social'], pressed: false, tags: ['Social'], movementIntensity: 3 },
  { text: 'Going to a Concert', iconLibrary: "ionicons", icon: "musical-notes", keywords: ['Music', 'Live Music', 'Band'], pressed: false, tags: ['Social', 'Entertainment'], movementIntensity: 3 },
  // Add Logos
